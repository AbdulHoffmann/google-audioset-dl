...
class CLIManager():
    ...
    def __init__(cls):
        ...
        parser.add_argument('-a', '--proc-audio', help='Initiate audio postprocessing', dest='postprocess_audio' , action='store_true')
        parser.add_argument('-p','--only-play', help='Only runs the audios without exporting the trimmed audio', action='store_true')
        parser.add_argument('--print-df', help='Outputs each of the filtered dataframes to the terminal', dest='print', action='store_true')
